...
class Rc1 extends Component{
    constructor(){
        super()
        this.rc1 = React.createRef();
    }
    componentDidMount(){
        ...
        ////////////////////////////////////////
        //rc0
        var svg = d3.select(this.rc1.current)
...
// A stateful closure for stacking bars horizontally.
    ...
    render(){
        return(
            <svg id="rc1" ref={this.rc1} width="500px" height="400px" style={{fill:"none"}}></svg>
        )
    }
}
export default Rc1